...
hooks.after.preloading(() => {
    ...
    // workaround to support transaction on object deletes
    Model.prototype.delete = async function (txn=null) {
        ...
        /**
        * If model was deleted then freeze it modifications
        */
        if (affected > 0) {
            this.freeze();
        }
...
// Response related modifications
